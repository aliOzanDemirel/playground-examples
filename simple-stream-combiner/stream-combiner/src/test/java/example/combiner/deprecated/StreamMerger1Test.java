...
public class StreamMerger1Test {

    private StreamMerger1 merger;
    private JsonOutput.BufferWriter writer;

    @BeforeEach
    void beforeEach() {
        writer = new JsonOutput.BufferWriter();
        merger = new StreamMerger1(writer, 2);
    }
